    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Przyklad2()
        {
            //1. Query syntax (SQL)
            var res = from emp in Emps
                      where emp.Salary > 1000 && emp.Job == "Frontend programmer"
                      orderby emp.Ename descending
                      select emp;
            //2. Lambda and Extension methods
            var res2 = Emps
                .Where(emp => emp.Salary > 1000 && emp.Job == "Frontend programmer")
        ...
        public void Przyklad7()
        {
            ...
            var res = Emps
                ...
                {
                    Praca = emp.Job,
                    LiczbaPracownikow = Emps.Count(emp2 => emp2.Job == emp.Job)
                })
        ...
        public void Przyklad10Button_Click()
        {
            ...
            var res = Emps
                ...
                .Where(emp => emp.Ename == "Brak wartości" && emp.Job == null && emp.HireDate == null));
        }
